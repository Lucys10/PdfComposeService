...
type PdfComposeClient interface {
	PostSend(ctx context.Context, in *Upfile, opts ...grpc.CallOption) (*Pdf, error)
}
...
func (c *pdfComposeClient) PostSend(ctx context.Context, in *Upfile, opts ...grpc.CallOption) (*Pdf, error) {
	out := new(Pdf)
	err := c.cc.Invoke(ctx, "/pdfcompose.PdfCompose/PostSend", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type PdfComposeServer interface {
	PostSend(context.Context, *Upfile) (*Pdf, error)
...
func (UnimplementedPdfComposeServer) PostSend(context.Context, *Upfile) (*Pdf, error) {
	return nil, status.Errorf(codes.Unimplemented, "method PostSend not implemented")
}
...
func _PdfCompose_PostSend_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(Upfile)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PdfComposeServer).PostSend(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/pdfcompose.PdfCompose/PostSend",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PdfComposeServer).PostSend(ctx, req.(*Upfile))
	}
